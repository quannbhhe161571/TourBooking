...
User::User(const std::string& username, const std::string& password, const std::string& displayName,
...
User::User(const User& other) : Person(other.m_username, other.m_password, other.m_displayName, other.m_gender, other.m_address, other.m_dob, other.m_email, other.m_phoneNumber, other.m_role) {}
...
bool User::changeDisplayName(const std::string& displayName)
{
...
bool User::changeAddress(const std::string& address)
{
    m_address = address;
    PersonDAO* personDao = new PersonDAO();
...
bool User::changeDob(const std::string& dob)
{
    m_dob = dob;
    PersonDAO* personDao = new PersonDAO();
...
bool User::changeEmail(const std::string& email)
{
    m_email = email;
    PersonDAO* personDao = new PersonDAO();
...
bool User::changePhoneNumber(const std::string& phoneNumber)
{
